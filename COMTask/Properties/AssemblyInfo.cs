...
// The ActivationOption attribute indicates whether the component will be activated within the caller's process. You can set
// Activation.Option to Library or to Server.
[assembly: ApplicationActivation(ActivationOption.Server)]

// The ApplicationName attribute is the name that appears for the COM+ application in the COM+ Catalog and the Component Services
...
// The Description attribute provides a description for the COM+ application in the COM+ Catalog and Component Services Administration console.
